...
# Edited from: https://github.com/micropython/micropython/blob/master/examples/bluetooth/ble_uart_peripheral.py
...
class BLEUART:
    ...
    def read(self, sz=None):
		...
		result = self._rx_buffer[0:sz].decode().strip()
